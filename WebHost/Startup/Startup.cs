...
namespace WebHost.Startup
{
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseRouting();
            //this asdds application middleware...but...
            //why is it needed? It works without? I am guessing it has somethign to do with teh API checking the token?
            ...
            //Auth needs to also be placed here between useRouting and UseEnpoints or gives an error
